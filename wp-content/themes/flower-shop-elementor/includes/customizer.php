...
if ( class_exists("Kirki")){
	...
	Kirki::add_section( 'flower_shop_elementor_theme_color_setting', array(
		'title'    => __( 'Color Option', 'flower-shop-elementor' ),
		'priority' => 10,
	) );

	Kirki::add_field( 'theme_config_id', array(
		'settings'    => 'flower_shop_elementor_theme_color',
		'label'       => __( 'Theme color', 'flower-shop-elementor'),
		'description'    => esc_html__( 'To customize the colors of the homepage, use the Elementor editor', 'flower-shop-elementor' ),
		'section'     => 'flower_shop_elementor_theme_color_setting',
		'type'        => 'color',
		'default'     => '#7469B6',
	) );
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'custom',
		'settings'    => 'flower_shop_elementor_show_related_product_heading',
		'section'     => 'flower_shop_elementor_woocommerce_settings',
			'default'         => '<h3 style="color: #2271b1; padding:10px; background:#fff; margin:0; border-left: solid 5px #2271b1; ">' . __( 'Related Product', 'flower-shop-elementor' ) . '</h3>',
		'priority'    => 10,
	] );

	Kirki::add_field( 'theme_config_id', [
		'type'        => 'toggle',
		'settings'    => 'flower_shop_elementor_show_related_product',
		'label'       => esc_html__( 'Enable or Disable Related Product', 'flower-shop-elementor' ),
		'section'     => 'flower_shop_elementor_woocommerce_settings',
		'default'     => true,
		'priority'    => 10,
	] );
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'custom',
		'tab'      => 'general',
		'settings'    => 'flower_shop_elementor_scroll_alignment_heading',
		'section'     => 'flower_shop_elementor_additional_setting',
		'default'     => '<h3 style="color: #2271b1; padding:10px; background:#fff; margin:0; border-left: solid 5px #2271b1; ">' . __( 'Scroll To Top Position', 'flower-shop-elementor' ) . '</h3>',
	] );

	Kirki::add_field( 'theme_config_id', array(
		'type'        => 'radio-buttonset',
		'tab'      => 'general',
		'settings'    => 'flower_shop_elementor_scroll_alignment',
		'section'     => 'flower_shop_elementor_additional_setting',
		'default'     => 'right',
		'choices'     => [
			'left' => esc_html__( 'left', 'flower-shop-elementor' ),
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'custom',
		'tab'      => 'general',
		'settings'    => 'flower_shop_elementor_scroller_border_radius_heading',
		'section'     => 'flower_shop_elementor_additional_setting',
		'default'     => '<h3 style="color: #2271b1; padding:10px; background:#fff; margin:0; border-left: solid 5px #2271b1; ">' . __( 'Scroll To Top Border Radius', 'flower-shop-elementor' ) . '</h3>',
	] );

	Kirki::add_field( 'theme_config_id', array(
		'type'        => 'slider',
		'tab'      => 'general',
		'settings'    => 'flower_shop_elementor_scroller_border_radius',
		'section'     => 'flower_shop_elementor_additional_setting',
		'default'     => '3',
		'choices'     => [
			'min'  => 0,
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'custom',
		'tab'      => 'general',
		'settings'    => 'flower_shop_elementor_cursor_outline_heading',
		'section'     => 'flower_shop_elementor_additional_setting',
			'default'         => '<h3 style="color: #2271b1; padding:10px; background:#fff; margin:0; border-left: solid 5px #2271b1; ">' . __( 'Dot Cursor', 'flower-shop-elementor' ) . '</h3>',
		'priority'    => 10,
	] );
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'toggle',
		'tab'      => 'general',
		'settings'    => 'flower_shop_elementor_cursor_outline',
		'label'       => esc_html__( 'Enable or Disable Dot Cursor', 'flower-shop-elementor' ),
		'section'     => 'flower_shop_elementor_additional_setting',
		'default'     => false,
		'priority'    => 10,
	] );
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'custom',
		'tab'      => 'general',
		'settings'    => 'flower_shop_elementor_progress_bar_heading',
		'section'     => 'flower_shop_elementor_additional_setting',
			'default'         => '<h3 style="color: #2271b1; padding:10px; background:#fff; margin:0; border-left: solid 5px #2271b1; ">' . __( 'Progress Bar', 'flower-shop-elementor' ) . '</h3>',
		'priority'    => 10,
	] );
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'toggle',
		'tab'      => 'general',
		'settings'    => 'flower_shop_elementor_progress_bar',
		'label'       => esc_html__( 'Enable or Disable Progress Bar', 'flower-shop-elementor' ),
		'section'     => 'flower_shop_elementor_additional_setting',
		'default'     => true,
		'priority'    => 10,
	] );
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'custom',
		'tab'      => 'general',
		'settings'    => 'flower_shop_elementor_progress_bar_position_heading',
		'section'     => 'flower_shop_elementor_additional_setting',
			'default'         => '<h3 style="color: #2271b1; padding:10px; background:#fff; margin:0; border-left: solid 5px #2271b1; ">' . __( 'Progress Bar Position', 'flower-shop-elementor' ) . '</h3>',
		'priority'    => 10,
		'active_callback'  => [
			[
				'setting'  => 'flower_shop_elementor_progress_bar',
				'operator' => '===',
				'value'    => true,
			],
		]
	...
	Kirki::add_field( 'theme_config_id', array(
		'type'        => 'select',
		'tab'      => 'general',
		'settings'    => 'flower_shop_elementor_progress_bar_position',
		'section'     => 'flower_shop_elementor_additional_setting',
		'default'     => 'top',
		'choices'     => [
			'top' => esc_html__( 'Top', 'flower-shop-elementor' ),
			'bottom' => esc_html__( 'Bottom', 'flower-shop-elementor' ),
		],
		'active_callback'  => [
			[
				'setting'  => 'flower_shop_elementor_progress_bar',
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'custom',
		'tab'      => 'general',
		'settings'    => 'flower_shop_elementor_progress_bar_color_heading',
		'section'     => 'flower_shop_elementor_additional_setting',
			'default'         => '<h3 style="color: #2271b1; padding:10px; background:#fff; margin:0; border-left: solid 5px #2271b1; ">' . __( 'Progress Bar Color', 'flower-shop-elementor' ) . '</h3>',
		'priority'    => 10,
		'active_callback'  => [
			[
				'setting'  => 'flower_shop_elementor_progress_bar',
	...
	Kirki::add_field( 'theme_config_id', array(
		'settings'    => 'flower_shop_elementor_progress_bar_color',
		'tab'      => 'general',
		'label'       => __( 'Color', 'flower-shop-elementor' ),
		'type'        => 'color',
		'section'     => 'flower_shop_elementor_additional_setting',
		'transport' => 'auto',
		'default'     => '#7469b6',
	...
	Kirki::add_field( 'theme_config_id', array(
	 ...
	 Kirki::add_field( 'theme_config_id', [
		'type'        => 'custom',
		'tab'      => 'header-image',
		'settings'    => 'flower_shop_elementor_header_image_height_heading',
		'section'     => 'flower_shop_elementor_additional_setting',
		'default'     => '<h3 style="color: #2271b1; padding:10px; background:#fff; margin:0; border-left: solid 5px #2271b1; ">' . __( 'Header Image height', 'flower-shop-elementor' ) . '</h3>',
	] );

	Kirki::add_field( 'theme_config_id', array(
		'settings'    => 'flower_shop_elementor_header_image_height',
		'label'       => __( 'Image Height', 'flower-shop-elementor' ),
		'description'    => esc_html__( 'Enter a value in pixels. Example:500px', 'flower-shop-elementor' ),
		'type'        => 'text',
		'tab'      => 'header-image',
		'default'    => [
			'desktop' => '550px',
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'custom',
		'tab'      => 'blog-post',
		'settings'    => 'flower_shop_elementor_show_pagination_heading',
		'section'     => 'flower_shop_elementor_blog_post',
			'default'         => '<h3 style="color: #2271b1; padding:10px; background:#fff; margin:0; border-left: solid 5px #2271b1; ">' . __( 'Blog Post Pagination', 'flower-shop-elementor' ) . '</h3>',
		'priority'    => 10,
	] );
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'toggle',
		'tab'      => 'blog-post',
		'settings'    => 'flower_shop_elementor_show_pagination',
		'label'       => esc_html__( 'Enable or Disable Blog Post Pagination', 'flower-shop-elementor' ),
		'section'     => 'flower_shop_elementor_blog_post',
		'default'     => true,
		'priority'    => 10,
	] );
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'custom',
		'tab'      => 'single-post',
		'settings'    => 'flower_shop_elementor_show_related_post_heading',
		'section'     => 'flower_shop_elementor_blog_post',
			'default'         => '<h3 style="color: #2271b1; padding:10px; background:#fff; margin:0; border-left: solid 5px #2271b1; ">' . __( 'Related post', 'flower-shop-elementor' ) . '</h3>',
		'priority'    => 10,
	] );
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'toggle',
		'tab'      => 'single-post',
		'settings'    => 'flower_shop_elementor_show_related_post',
		'label'       => esc_html__( 'Enable or Disable Related post', 'flower-shop-elementor' ),
		'section'     => 'flower_shop_elementor_blog_post',
		'default'     => true,
		'priority'    => 10,
	] );
    ...
    Kirki::add_field( 'theme_config_id', [
		'type'        => 'custom',
		'settings'    => 'flower_shop_elementor_show_footer_widget_heading',
		'section'     => 'flower_shop_elementor_footer_section',
			'default'         => '<h3 style="color: #2271b1; padding:10px; background:#fff; margin:0; border-left: solid 5px #2271b1; ">' . __( 'Enable / Disable', 'flower-shop-elementor' ) . '</h3>',
		'priority'    => 10,
	] );

	Kirki::add_field( 'theme_config_id', [
		'type'        => 'toggle',
		'settings'    => 'flower_shop_elementor_show_footer_widget',
		'label'       => esc_html__( 'Footer Widget', 'flower-shop-elementor' ),
		'section'     => 'flower_shop_elementor_footer_section',
		'default'     => '1',
		'priority'    => 10,
	] );
	...
	Kirki::add_field( 'theme_config_id', [
		'type'        => 'toggle',
		'settings'    => 'flower_shop_elementor_show_footer_copyright',
		'label'       => esc_html__( 'Footer Copyright', 'flower-shop-elementor' ),
		'section'     => 'flower_shop_elementor_footer_section',
		'default'     => '1',
		'priority'    => 10,
	] );
