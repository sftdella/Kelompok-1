...
if (!function_exists('flower_shop_elementor_enqueue_scripts')) {
	...
	function flower_shop_elementor_enqueue_scripts() {
		...
		wp_add_inline_style( 'flower-shop-elementor-style',$flower_shop_elementor_theme_custom_setting_css );
	...
	echo '<div class="notice notice-info wpele-activation-notice is-dismissible">';
		echo '<div class="notice-body">';
			echo '<div class="notice-content">';
				...
				echo '<span><a href="'. esc_url( admin_url( 'themes.php?page=flower_shop_elementor_about' ) ) .'" class="button button-notice">'. esc_html__( 'GET STARTED', 'flower-shop-elementor' ) .'</a></span>';
				echo '<span><a href="'. esc_url( FLOWER_SHOP_ELEMENTOR_BUY_NOW ) .'" class="button button-notice" target="_blank" >'. esc_html__( 'BUY NOW', 'flower-shop-elementor' ) .'</a></span>';
				echo '<span><a href="'. esc_url( FLOWER_SHOP_ELEMENTOR_LIVE_DEMO ) .'" class="button button-notice" target="_blank" >'. esc_html__( 'DEMO', 'flower-shop-elementor' ) .'</a></span>';
			echo '</div>';
...
function flower_shop_elementor_enqueue_setting() {
...
add_action('after_setup_theme', 'flower_shop_elementor_enqueue_setting');
?>