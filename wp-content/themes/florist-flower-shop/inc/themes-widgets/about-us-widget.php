...
class Florist_Flower_Shop_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'Florist_Flower_Shop_About_Widget',
			__('VW About us', 'florist-flower-shop'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'florist-flower-shop' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','florist-flower-shop'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','florist-flower-shop'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','florist-flower-shop'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','florist-flower-shop'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','florist-flower-shop'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','florist-flower-shop'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function florist_flower_shop_about_custom_load_widget() {
	register_widget( 'Florist_Flower_Shop_About_Widget' );
}
add_action( 'widgets_init', 'florist_flower_shop_about_custom_load_widget' );