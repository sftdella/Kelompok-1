...
if ( ! class_exists( 'Florist_Flower_Shop_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Florist_Flower_Shop_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'florist_flower_shop_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function florist_flower_shop_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Florist_Flower_Shop_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( 'florist_flower_shop_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function florist_flower_shop_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new Florist_Flower_Shop_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
