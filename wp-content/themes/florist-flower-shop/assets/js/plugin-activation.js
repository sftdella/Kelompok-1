jQuery(document).ready(function($) {
    'use strict';
    var this_obj = florist_flower_shop_plugin_activate_plugin;
    ...
    $(document).on('click', '.florist-flower-shop-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message florist-flower-shop-plugin-install');
                button.addClass('button-primary florist-flower-shop-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.florist-flower-shop-recommended-plugins .florist-flower-shop-activation-note').css('display','block');
    ...
    $(document).on('click', '.florist-flower-shop-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .florist-flower-shop-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .florist-flower-shop-recommended-plugins').css('display','none');
    });
