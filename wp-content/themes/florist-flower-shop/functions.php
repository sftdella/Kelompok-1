	...
	echo '<div class="notice notice-success is-dismissible welcome-notice">';
		echo '<div class="notice-row">';
			echo '<div class="notice-text">';
				echo '<p class="welcome-text1">'. esc_html__( '🎉 Welcome to VW Themes,', 'florist-flower-shop' ) .'</p>';
				echo '<p class="welcome-text2">'. esc_html__( 'You are now using the Florist Flower Shop, a beautifully designed theme to kickstart your website.', 'florist-flower-shop' ) .'</p>';
				echo '<p class="welcome-text3">'. esc_html__( 'To help you get started quickly, use the options below:', 'florist-flower-shop' ) .'</p>';
				echo '<span class="import-btn"><a href="'. esc_url( admin_url( 'themes.php?page=florist_flower_shop_guide' ) ) .'" class="button button-primary">'. esc_html__( 'IMPORT DEMO', 'florist-flower-shop' ) .'</a></span>';
				...
				echo '<span class="upgrade-btn"><a href="'. esc_url( 'https://www.vwthemes.com/products/flower-shop-wordpress-theme' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'UPGRADE TO PRO', 'florist-flower-shop' ) .'</a></span>';
				echo '<span class="bundle-btn"><a href="'. esc_url( 'https://www.vwthemes.com/products/wp-theme-bundle' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'BUNDLE OF 350+ THEMES', 'florist-flower-shop' ) .'</a></span>';
			echo '</div>';
			echo '<div class="notice-img1">';
				echo '<img src="' . esc_url( get_template_directory_uri() . '/inc/getstart/images/arrow-notice.png' ) . '" width="180" alt="' . esc_attr__( 'Florist Flower Shop', 'florist-flower-shop' ) . '" />';
			echo '</div>';
			echo '<div class="notice-img2">';
				echo '<img src="' . esc_url( get_template_directory_uri() . '/inc/getstart/images/bundle-notice.png' ) . '" width="180" alt="' . esc_attr__( 'Florist Flower Shop', 'florist-flower-shop' ) . '" />';
			echo '</div>';	
		echo '</div>';	
	echo '</div>';
}
...
function florist_flower_shop_font_url() {
	...
	return $font_url;
	$contents = florist_flower_shop_wptt_get_webfont_url( esc_url_raw( $fonts_url ) );
}
...
function florist_flower_shop_init_setup() {
...
add_action( 'after_setup_theme', 'florist_flower_shop_init_setup' );	