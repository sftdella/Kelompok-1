<?php
/**
 * Blossom Pin Footer Setting
 *
 * @package Blossom_Pin
 */

function blossom_pin_customize_register_footer( $wp_customize ) {
    
    $wp_customize->add_section(
        'footer_settings',
        array(
            'title'      => __( 'Footer Settings', 'blossom-pin' ),
            'priority'   => 199,
    ...
    $wp_customize->add_control(
        'footer_copyright',
        array(
            'label'   => __( 'Footer Copyright Text', 'blossom-pin' ),
    ...
    $wp_customize->selective_refresh->add_partial( 'footer_copyright', array(
        ...
        'render_callback' => 'blossom_pin_get_footer_copyright',
    ) );
...
add_action( 'customize_register', 'blossom_pin_customize_register_footer' );