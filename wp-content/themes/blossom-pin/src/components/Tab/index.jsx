		...
		return (
			<>
				<div className="get-pro">
					<h3>{__('Blossom Pin Pro', 'blossom-pin')}</h3>
					<p>{__('Get access to all unlimited features.', 'blossom-pin')}</p>
					<a className="cw-button-btn primary-btn" target="_blank" href={cw_dashboard.get_pro}>{__('Get Pro', 'blossom-pin')}</a>
				</div>
			</>
		);
	}
		...
		<div className="cw-tabs-container">
			<div className="cw-tabs">
				<div className="wrapper">
					<div className="top">
						<div className="logo">
							<img src={logo} alt={__('Logo', 'blossom-pin')} />
						</div>
