...
const pluginList = [
    {
        pluginName: __("BlossomThemes Email Newsletter", "blossom-pin"),
        description: __("Easily add email subscription form to your website using shortcode and widget.", "blossom-pin"),
        slug: "blossomthemes-email-newsletter"
    },
    {
        pluginName: __( 'BlossomThemes Toolkit', 'blossom-pin' ),
        description: __("BlossomThemes Toolkit provides you necessary widgets for better and effective blogging.", "blossom-pin"),
        slug: "blossomthemes-toolkit"
    },
    {
        pluginName: __("Regenerate Thumbnails", "blossom-pin"),
        description: __("Regenerate the thumbnails for one or more of your image uploads. Useful when changing their sizes or your theme.", "blossom-pin"),
        slug: "regenerate-thumbnails"
    },
    {
        pluginName: __("AffiliateX - Best Amazon Affiliate WordPress Plugin", "blossom-pin"),
        description: __("Create a professional-looking affiliate websites with highly customizable blocks that help in increasing the conversion rate and boost your affiliate income.", "blossom-pin"),
        slug: "affiliatex"
    },
    {
        pluginName: __("Smash Balloon Social Photo Feed", "blossom-pin"),
        description: __("Formerly 'Instagram Feed'. Display clean, customizable, and responsive Instagram feeds from multiple accounts. Supports Instagram oEmbeds.", "blossom-pin"),
        slug: "instagram-feed"
    },
];
